...
const restaurant = {
  ...
  orderDelivery({ starterIndex = 1, mainIndex = 0, time = '10:00', address }) {
    console.log(
      `Order receivedre! ${this.starterMenu[starterIndex]} and ${this.mainMenu[mainIndex]} will be delivered to ${address} at ${time}`
    );
  },
